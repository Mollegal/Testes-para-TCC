...
#variavel
def calculomd():
    Mk = float(entry_1.get())
    Md = Mk*1.4*100.0

    label_2.config(text=round(Md, 1))
...
entry_1 = customtkinter.CTkEntry(master=frame_1, width=40, textvariable="Mk")
entry_1.grid(column=1, row=0, padx=10, pady=10)

#botão
button_1 = customtkinter.CTkButton(master=frame_1, text="Resultado", command=calculomd)
